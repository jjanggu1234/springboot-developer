...
class QuizControllerTest {
    ...
    @Autowired
    private ObjectMapper objectMapper;  // JSON ↔ Java 객체 간의 변환(Serialization/Deserialization)을 도와주는 도구
    //Code coe = new Code(13)
    //objectMapper.writeValueAsString(code) -> {'value' : 13} 로 JSON 형태의 문자열로 객체가 변환 = 객체 직렬화
